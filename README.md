...
Se van a usar entornos de desarrollo  como visualstudiocode(XML,XSD),sql,intellij(Java).

Va a ser una app en local entonces para poder ejecutarlo necesitarás descargarte todo y ejecutarlo desde tu Pc después de descargarlo.

La estructura va a ser Programación, Bases de Datos, Sistemas, Lenguaje de Marcas.
